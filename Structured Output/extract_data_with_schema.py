# A schema is like a blueprint or template that says, "I want the answer in this specific format."
# https://github.com/ollama/ollama-python/blob/main/examples/structured-outputs.py
...
if "message" in response and "content" in response["message"]:
    ...
    print("\nFriends response:", friends_response)
else:
